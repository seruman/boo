...
{{- end}}
	set t to split terminal id "{{escape .TerminalID}}" direction {{.Direction}} with configuration cfg
{{- else}}
	set t to split terminal id "{{escape .TerminalID}}" direction {{.Direction}}
{{- end}}
	return id of t
end tell
